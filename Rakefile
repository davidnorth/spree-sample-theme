...
desc 'Generate documentation for the sample_theme extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'SampleThemeExtension'
...
desc 'Test the sample_theme extension.'
...
namespace :test do
  desc 'Functional test the sample_theme extension.'
  ...
  desc 'Unit test the sample_theme extension.'
